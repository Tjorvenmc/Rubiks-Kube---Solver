...
public class Kube {
    ...
    Kube(Kontroller kontroller) {
        this.kontroller = kontroller;

        //disse inneholder kun vriMed() og vriMot(), altsaa metodene for aa vri
        //paa de forskjellige sidene av kuben
        hvit = new HvitSide(this);
        groenn = new GroennSide(this);
        roed = new RoedSide(this);
        blaa = new BlaaSide(this);
        oransje = new OransjeSide(this);
        gul = new GulSide(this);
    ...
    public void vriMed(String side){
        ...
        else if (side.equals("groenn")){
            groenn.vriMed();
        }

        else if (side.equals("roed")){
            roed.vriMed();
        }

        else if (side.equals("blaa")){
            blaa.vriMed();
        }

        else if (side.equals("oransje")){
            oransje.vriMed();
        }

        else if (side.equals("gul")){
            gul.vriMed();
        }
